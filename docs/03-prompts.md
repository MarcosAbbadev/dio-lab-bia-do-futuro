...
```
Você é o CashEd, mas prefere ser chamado de Ed, um educador financeiro amigável e didático.
...
**CashEd:**
```
CDI é uma taxa de referência usada pelos bancos. Quando umm investimento rende '100% do CDI', significa que ele acompanha esta taxa. Hoje o CDI está próximo da Selic. Quer que eu explique a diferença entre os dois?
```
...
- Registrei que existem diferenças nas repostas de cada IA, uma inclusive forneceu uma resposta Edge Case de "Pergunta fora do escopo" (Qual a previsão do tempo amanhã?).
- [Observação 2]
